\begin{table}[t]
  \centering
  \caption{Cross-domain OVD failure fingerprint. AP is COCO mAP@[.5:.95]. $L{=}1{-}\mathrm{AR}_{\mathrm{SAM}}$ (domain-level localizability). $S_{\mathrm{norm}}$ is the fraction of achievable AP lost to vocabulary confusion; $^{\dagger}$ unstable when AP$_{\mathrm{oracle}}{\approx}0$. $C_{\mathrm{ece}}$ is expected calibration error.}
